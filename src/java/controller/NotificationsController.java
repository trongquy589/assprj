 ...
 * @author troqu
 */
@WebServlet(name="NotificationsController", urlPatterns={"/thongbao"})
public class NotificationsController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        List<Notification> notificationList = notificationsDAO.getAll();
        
        
        request.setAttribute("notificationList", notificationList);
//        PrintWriter out= response.getWriter();
//        out.print(employeeList.size()+1);
        request.getRequestDispatcher("police/notifications.jsp").forward(request, response);
    } 
